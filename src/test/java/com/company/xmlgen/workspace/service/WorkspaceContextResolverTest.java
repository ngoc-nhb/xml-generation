...
class WorkspaceContextResolverTest {
    ...
    void resolve_activeWorkspace() {
        WorkspaceEntity entity =
                new WorkspaceEntity("DEFAULT", "Default Workspace", WorkspaceStatus.ACTIVE, WorkspaceType.GLOBAL, 1L);
    ...
    void resolve_inactiveWorkspace() {
        WorkspaceEntity entity =
                new WorkspaceEntity("INACTIVE", "Inactive", WorkspaceStatus.INACTIVE, WorkspaceType.GLOBAL, 1L);
